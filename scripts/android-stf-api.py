...
def main(argv):
    ...
    ADB_KEY_LOCATION = "/home/www/.android/adbkey.pub" \
        # use this one to debug on Win10/Cygwin /cygdrive/c/Users/fr20445/.android/adbkey.pub"
    ...
    if (str(CMD) == "connect"):
        ...
        if (str(STATUS) == "True"):
            ...
            print("   SUCCESS : ADB remoteConnectUrl is reached (" + str(STF_ADB_ADRESS) + ")" + "\n")
            ...
            try:
                ...
                #    "curl -s -o /home/www/.android/adbkey https://.../adbkey")
                # adbPrubKeyDownload = os.system(
                #   "curl -s -o /home/www/.android/adbkey.pub https://.../adbkey.pub")
                ...
                print("-> Connecting to ADB device (" + str(STF_ADB_ADRESS) + ")...")
                result = os.system(ADB_PATH + " -e connect " + str(STF_ADB_ADRESS) + " > /dev/null ")

                if (result == 0):
                    print("   SUCCESS: Connecting ADB device with address: (" + str(STF_ADB_ADRESS) + ") " + "\n")

                else:
                    print("ERROR: connecting to ADB for device with address: " + STF_ADB_ADRESS)
                    exit(1)
    ...
    if (str(CMD) == "disconnect"):
        ...
        print("--> Searching for serial numbers of devices used by you from OpenSTF...")
        url = SERVER_URL + "/api/v1/user/devices/"
        token = str(STF_API_TOKEN)
        # proxies = {'http': 'yourproxy:3128'}
        headers = {'Content-type': 'application/json', 'Authorization': "Bearer " + token}
        ...
        try:
            ...
            print('Oops. Connection timeout occured, please try again later!')
        except requests.exceptions.HTTPError as err:
            print('Oops. HTTP Error occured, please try again later')
        ...
        try:
            for row in returned_data['devices']:
                ...
                print("\n" + "-> Disconnecting device ADB session from OpenSTF...")
            ...
            print('Oops. Connection ReadTimeout occured, try again later!')
        except requests.exceptions.HTTPError as err:
            print('Oops. HTTP Error occured, try again later')
            print('Response is: {content}'.format(content=err.response.content))
